...
open SubmainFunctions3
open SubmainFunctions3.KODIS_SubmainRecord3

module WebScraping_KODISFMRecord3 = 
    ...
    let internal webscraping_KODISFMRecord3 pathToDir (variantList: Validity list) = 
        ...
        let rec interpret clp  = 
            ...
            | Free (DownloadAndSaveJsonFM next)    
                ...
                try 
                    ...
                    SubmainFunctions3.KODIS_SubmainRecord3.downloadAndSaveJson (jsonLinkList @ jsonLinkList3) (pathToJsonList @ pathToJsonList3) 
                ...
                try
                    ...
                    try
                        ...
                        | 1 -> 
                            ...
                            //IO operation
                            KODIS_SubmainRecord3.deleteOneODISDirectory variant pathToDir 
                                                                                                                           
                            //operation on data 
                            let dirList =                                                                    
                                KODIS_SubmainRecord3.createOneNewDirectoryPath  //list -> aby bylo mozno pouzit funkci createFolders bez uprav  
                                <| pathToDir 
                                <| KODIS_SubmainRecord3.createDirName variant listODISDefault4 

                            //IO operation 
                            KODIS_SubmainRecord3.createFolders dirList
                            ...
                            let list = KODIS_SubmainRecord3.operationOnDataFromJson () variant dir 
                            ...
                            |> KODIS_SubmainRecord3.downloadAndSave 

                            //BulkVariantDownload       
                        | _ ->
                            //IO operation
                            KODIS_SubmainRecord3.deleteAllODISDirectories pathToDir                                                              
                                                              
                            //operation on data 
                            let dirList = KODIS_SubmainRecord3.createNewDirectoryPaths pathToDir listODISDefault4
